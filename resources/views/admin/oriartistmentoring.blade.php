...
@section('title') ORI ARTIST MENTORING Page @endsection
...
@section('content')
    ...
    @component('admin.components.breadcrumb')
        ...
        @slot('title') ORI ARTIST MENTORING Page @endslot
    @endcomponent
    ...
    <div class="card">
        <form method="POST" class="form-horizontal" action="/oriartistmentoring-update" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <label for="first_paragraph" class="col-sm-3 col-form-label">Content</label>
                                    <div class="col-sm-9">
                                        <textarea id="first_paragraph" name="first_paragraph">{{$record->first_paragraph}}</textarea>
