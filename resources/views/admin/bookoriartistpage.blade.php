...
@section('title') BOOKORIARTIST Page @endsection
...
@section('content')
    ...
    @component('admin.components.breadcrumb')
        ...
        @slot('title') BOOK ORI ARTIST Page @endslot
    @endcomponent
    ...
    <div class="card">
        <form method="POST" class="form-horizontal" action="/bookoriartistpage-update" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
