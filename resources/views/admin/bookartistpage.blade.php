...
@section('title') BOOK ARTIST Page @endsection
...
@section('content')
    ...
    @component('admin.components.breadcrumb')
        ...
        @slot('title') Book Artist Page @endslot
    @endcomponent
    ...
    <div class="card">
        <form method="POST" class="form-horizontal" action="/bookartistpage-update" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
