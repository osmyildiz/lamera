...
@section('content')
    ...
    @component('admin.components.breadcrumb')
        ...
        @slot('title') Homepage Testimonials Section @endslot
    @endcomponent
    ...
    <form method="POST" class="form-horizontal" action="/add-testimonial" enctype="multipart/form-data">
        @csrf
        <div class="row">
                                        ...
                                        <td>
                                            <ul class="list-inline font-size-20 contact-links mb-0">
                                                ...
                                                <li class="list-inline-item px-1">
                                                    <a href="{{route('testimonial.edit',$record->id)}}" title="edit" class="btn btn-xs btn-warning"><i class="bx bxs-edit text-white"></i></a>
                                                </li>
                                                <li class="list-inline-item px-1">
                                                    <form method="POST" action="{{ route('testimonial.delete',$record->id) }}">
                                                        @csrf
