                            ...
                            <div class="col-sm-9">
                                <select id="time" class="form-select" name="category">
                                    @foreach($kategori_all as $kategori)
                                        <option value="{{$kategori->id}}" {{$kategori->id == $kategori1->id?"selected":""}}>{{$kategori->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" type="text"
                                       value="{{$res->name}}"     id="name" autofocus name="name">
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="price"
                                       name="price" value="{{$res->price}}" required>
