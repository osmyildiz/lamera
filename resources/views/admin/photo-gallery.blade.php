...
@section('title') FOTO GALERİ @endsection
...
@section('content')
    ...
    @component('admin.components.breadcrumb')
        ...
        @slot('title') FOTO GALERİ SAYFASI @endslot
    @endcomponent
    ...
    <form method="POST" class="form-horizontal" action="/add-photo" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Yeni Fotoğraf Ekle</h4>

                        <div class="row mb-4">
                            <label for="url" class="col-sm-3 col-form-label">Foto</label>
                            <div class="col-sm-9">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Tüm fotoğrafları buradan inceleyebilirsiniz.</p>
